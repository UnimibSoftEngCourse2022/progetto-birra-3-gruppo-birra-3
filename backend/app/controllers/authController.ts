...
class AuthController {
    static signIn = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            let userExists = await UserModel.findOne({email: userBody.email}).select("_id email token firstname surname password");
    ...
    static signUp = async (req: Request, res: Response, next: NextFunction) => {
        try {
            ...
            let checkUserExist = await UserModel.findOne({email: userBody.email}).select("_id email");
