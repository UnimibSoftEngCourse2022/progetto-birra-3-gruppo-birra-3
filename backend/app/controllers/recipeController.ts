...
class RecipeController {
  ...
  static findAll = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const result = await RecipeModel.find(_params)
  ...
  static update = async (req: Request, res: Response, next: NextFunction) => {
    try {
      ...
      const checkRecipe: any = await RecipeModel.findOne(_params).populate(
        "ingredients"
      );
      ...
      if (checkRecipe) {
        ...
        const newIngredients = await IngredientModel.insertMany(
          body.ingredients
        );
